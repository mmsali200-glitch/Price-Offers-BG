...
export function SectionLicense() {
  ...
  return (
    <SectionCard icon="🔑" title="الترخيص والاستضافة" subtitle="السعر يتغير بناءً على نوع الخادم وعدد المستخدمين والعملة">
      ...
      <div className="mt-3 rounded-sm2 border-[1.5px] border-bg-gold bg-bg-gold-lt p-3 text-[10px] text-[#8a6010]">
        ℹ️ تكلفة ترخيص Odoo تظهر كبند منفصل ولا تُحتسب ضمن إجمالي العرض ولا الدفعات.
      </div>
    </SectionCard>
  );
}
