...
/** Selectors (derived values). Re-exported from the directive-free
 * totals module so server code can import them without pulling the
 * client store. */
export { selectedModules, selectedBGApps, computeTotals } from "./totals";
