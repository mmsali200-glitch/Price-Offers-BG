    ...
    modules: [
      {
        ...
        price: 1000,
        features: [
          "مكتبة مستندات مركزية بتصنيف شجري",
          "بحث متقدم بالاسم والمحتوى عبر OCR",
          "صلاحيات وصول دقيقة لكل مستند ومجلد",
          "ربط المستندات بسجلات النظام (مشروع/فاتورة/موظف)",
          "إدارة الإصدارات (Versioning)",
          "سجل تدقيق كامل + سياسات احتفاظ",
        ],
      },
      {
        id: "eapprovals",
        name: "الموافقات الإلكترونية",
        price: 850,
        features: [
          "مسارات موافقة متعددة المستويات",
          "موافقات شرطية حسب القيمة والقسم والنوع",
          "اعتماد من الجوال + إشعارات فورية",
          "تفويض الصلاحيات عند غياب المعتمد",
          "تذكيرات SLA وتصعيد تلقائي",
          "تكامل مع كل الموديولات (شراء/إجازات/مصاريف/فواتير)",
        ],
      },
    ],
  },
